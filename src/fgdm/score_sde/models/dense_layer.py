...
def _calculate_correct_fan(tensor: th.Tensor, mode: str):
    """
...
def kaiming_uniform_(tensor: th.Tensor, gain=1., mode='fan_in'):
...
def variance_scaling_init_(tensor: th.Tensor, scale):
